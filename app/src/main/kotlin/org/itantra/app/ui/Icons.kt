...
object Icons {
    ...
    val Transmit: ImageVector by lazy {
        vector(
            ...
            Part("M66.7 41.3A18 18 0 0166.7 66.7M41.3 41.3A18 18 0 0041.3 66.7M75.2 32.8A30 30 0 0175.2 75.2M32.8 32.8A30 30 0 0032.8 75.2", width = 7f, cap = StrokeCap.Round),
        )
    }
    ...
    val OpenLine: ImageVector by lazy {
        vector(
            "OpenLine", 24f,
            Part("M8.5 9.5a3.5 3.5 0 010 5M12.5 6.5a7.5 7.5 0 010 11M16.5 3.5a11.5 11.5 0 010 17", width = 2f, cap = StrokeCap.Round),
        )
    }
    ...
    val Grid: ImageVector by lazy {
        vector(
            "Grid", 24f,
            Part("M5.7 3.5H8.3A2.2 2.2 0 0 1 10.5 5.7V8.3A2.2 2.2 0 0 1 8.3 10.5H5.7A2.2 2.2 0 0 1 3.5 8.3V5.7A2.2 2.2 0 0 1 5.7 3.5Z", width = 2f),
            Part("M15.7 3.5H18.3A2.2 2.2 0 0 1 20.5 5.7V8.3A2.2 2.2 0 0 1 18.3 10.5H15.7A2.2 2.2 0 0 1 13.5 8.3V5.7A2.2 2.2 0 0 1 15.7 3.5Z", width = 2f),
            Part("M5.7 13.5H8.3A2.2 2.2 0 0 1 10.5 15.7V18.3A2.2 2.2 0 0 1 8.3 20.5H5.7A2.2 2.2 0 0 1 3.5 18.3V15.7A2.2 2.2 0 0 1 5.7 13.5Z", width = 2f),
            Part("M15.7 13.5H18.3A2.2 2.2 0 0 1 20.5 15.7V18.3A2.2 2.2 0 0 1 18.3 20.5H15.7A2.2 2.2 0 0 1 13.5 18.3V15.7A2.2 2.2 0 0 1 15.7 13.5Z", width = 2f),
        )
    }
    ...
    val TickDouble: ImageVector by lazy {
        vector(
            "TickDouble", 24f,
            Part("M2.5 12.8l4 4 7.5-8M9.5 16.8l1.5 1.5 9-9.6", width = 2.2f, cap = StrokeCap.Round, join = StrokeJoin.Round),
        )
    }
    ...
    val Fire: ImageVector by lazy {
        vector(
            "Fire", 24f,
            Part("M12 3.2c3.4 3.6 5.4 5.8 5.4 8.9a5.4 5.4 0 01-10.8 0c0-3.1 2-5.3 5.4-8.9z", width = 2f, join = StrokeJoin.Round),
            Part("M12 12.4c1.4 1.5 2.2 2.4 2.2 3.5a2.2 2.2 0 01-4.4 0c0-1.1.8-2 2.2-3.5z", width = 2f, join = StrokeJoin.Round),
        )
    }
    ...
    val Flood: ImageVector by lazy {
        vector(
            "Flood", 24f,
            Part("M2.5 7.5c2-2.4 4.5-2.4 6.5 0s4.5 2.4 6.5 0 4.5-2.4 6-.6M2.5 13c2-2.4 4.5-2.4 6.5 0s4.5 2.4 6.5 0 4.5-2.4 6-.6M2.5 18.5c2-2.4 4.5-2.4 6.5 0s4.5 2.4 6.5 0 4.5-2.4 6-.6", width = 2f, cap = StrokeCap.Round),
        )
    }
    ...
    val Evacuate: ImageVector by lazy {
        vector(
            "Evacuate", 24f,
            Part("M3.5 10.8L12 4l8.5 6.8M6.2 9.6V20h11.6V9.6", width = 2f, cap = StrokeCap.Round, join = StrokeJoin.Round),
    ...
    val Mic: ImageVector by lazy {
        vector(
            "Mic", 24f,
            Part("M12 3.5a2.9 2.9 0 012.9 2.9v5.2a2.9 2.9 0 01-5.8 0V6.4A2.9 2.9 0 0112 3.5z", width = 2f, join = StrokeJoin.Round),
    ...
    val Thermal: ImageVector by lazy {
        vector(
            "Thermal", 24f,
            Part("M12 3.5a2.2 2.2 0 012.2 2.2v8.6a4.2 4.2 0 11-4.4 0V5.7A2.2 2.2 0 0112 3.5z", width = 2f, join = StrokeJoin.Round),
    ...
    val Storage: ImageVector by lazy {
        vector(
            "Storage", 24f,
            Part("M3.6 7c0-1.7 3.8-3 8.4-3s8.4 1.3 8.4 3-3.8 3-8.4 3-8.4-1.3-8.4-3z", width = 2f, join = StrokeJoin.Round),
            Part("M3.6 12c0 1.7 3.8 3 8.4 3s8.4-1.3 8.4-3M3.6 7v10c0 1.7 3.8 3 8.4 3s8.4-1.3 8.4-3V7", width = 2f, cap = StrokeCap.Round),
        )
    }
    ...
    val Bluetooth: ImageVector by lazy {
        vector(
            "Bluetooth", 24f,
            Part("M8.5 7.5L16 16.2 12 19.8V4.2l4 3.6L8.5 16.5", width = 2f, cap = StrokeCap.Round, join = StrokeJoin.Round),
        )
    }
    ...
    val LockOpen: ImageVector by lazy {
        vector(
            "LockOpen", 24f,
            Part("M7.5 10.5H16.5A2 2 0 0 1 18.5 12.5V18A2 2 0 0 1 16.5 20H7.5A2 2 0 0 1 5.5 18V12.5A2 2 0 0 1 7.5 10.5Z", width = 2f),
    ...
    val Download: ImageVector by lazy {
        vector(
            "Download", 24f,
            Part("M12 3.5v10.8M7.6 10.4L12 14.8l4.4-4.4M4.5 19.5h15", width = 2f, cap = StrokeCap.Round, join = StrokeJoin.Round),
        )
    }
    ...
    val Qr: ImageVector by lazy {
        vector(
            "Qr", 24f,
            Part("M4 9.5v-5h5M15 4.5h5v5M20 14.5v5h-5M9 19.5H4v-5", width = 2f, cap = StrokeCap.Round, join = StrokeJoin.Round),
    ...
    val Aeroplane: ImageVector by lazy {
        vector(
            "Aeroplane", 24f,
            Part("M12 3l2 7.5 7 2.5v2l-7-1.2-1 4.7 2.5 1.8v1.2L12 20l-3.5 1.5v-1.2L11 18.5l-1-4.7-7 1.2v-2l7-2.5z", fill = true),
        )
    }
